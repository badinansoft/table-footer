...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ResourceTable_vue__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_ResourceTable_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_ResourceTable_vue__);


Nova.booting(function (Vue) {
    Vue.component('resource-table', __WEBPACK_IMPORTED_MODULE_0__components_ResourceTable_vue___default.a);
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
          ...
          switch (_context.prev = _context.next) {
            case 0:
              if (this.resources.length > 0 && this.resources[0].fields) {
                this.calculate = [];
                this.resources[0].fields.forEach(function (field) {
                  if (field.calculate) {
                    _this.putFiledCalculate({
  ...
  methods: {
    ...
    putFiledCalculate: function putFiledCalculate(field) {
      this.calculate.push(field);
    },
    fetchCalculate: function fetchCalculate() {
      var _this2 = this;

      var fields = _extends({}, this.resourceRequestQueryString, {
        calculate: this.calculate
      });
      Nova.request().get('/nova-vendor/table-footer/calculate/' + this.resourceName, {
        params: fields
      }).then(function (response) {
        if (response.data) {
          _this2.calculate.forEach(function (field) {
            if (response.data[field.indexName]) {
              _this2.calculate.find(function (o) {
                return o.indexName === field.indexName;
              }).value = response.data[field.indexName];
            }
          });
        }
  ...
  return _vm.resources.length > 0
    ? _c(
        "table",
        {
          ...
          class: [
            "table-" + _vm.resourceInformation.tableStyle,
            _vm.resourceInformation.showColumnBorders ? "table-grid" : ""
          ],
          attrs: {
            cellpadding: "0",
            cellspacing: "0",
            ...
            _vm._l(_vm.resources, function(resource, index) {
              return _c("resource-table-row", {
                ...
                attrs: {
                  ...
                  "actions-endpoint": _vm.actionsEndpoint,
            ...
            ? _c("tfoot", [
                _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _vm._l(_vm.fields, function(field) {
                      return _c("th", { class: "text-" + field.textAlign }, [
                      ...
                      return _c("th", { class: "text-" + field.textAlign }, [
                        ...
                        field.calculate
                          ? _c("span", [
                              _vm._v(
                                _vm._s(
                                  _vm.calculate.find(function(o) {
                                    return o.indexName === field.sortableUriKey
                                  })
                                    ? _vm.calculate.find(function(o) {
                                        return (
                                          o.indexName === field.sortableUriKey
                                        )
                                      }).value
                                    : 0
                                )
